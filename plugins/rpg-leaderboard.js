...
${usedPrefix}${command} legendary`.trim()
  ...
  return conn.sendButton(m.chat,'*––––『 LEADERBOARD 』––––*', wrong, tran + 'Leaderboard', [
...
`.trim()
  return conn.sendButton(m.chat, `*–『 GLOBAL LEADERBOARD 』–*`, text, tran + 'Leaderboard',[
